...
//        .hasPath("/");
  ...
  public void equalsHashCodeAndToStringWork() {
    ...
    Assertions.assertThat(t1.hashCode())
        .isEqualTo(i1.hashCode());

    Assertions.assertThat(t1.toString())
  ...
  public void decodeLogicSupportsByteArray() throws Exception {
    ...
    Assertions.assertThat(api.binaryResponseBody())
...
//    Feign.ResponseMappingDecoder decoder = new Feign.ResponseMappingDecoder(upperCaseResponseMapper(), new StringDecoder());
